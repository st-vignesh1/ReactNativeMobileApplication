...
const Claims = ({data,color}) => {
    console.log(color)
;  return (
   <SafeAreaView>
    <View className='w-full h-fit flex-row p-4 justify-between items-center'>
    <View className='flex-row items-center gap-4'>
        <View style={{backgroundColor:color}} className=" w-12 h-12 rounded-full flex justify-center items-center "><Text className='text-white text-xl font-bold capitalize'>
            {data.company[0]}
            </Text>
            </View>
